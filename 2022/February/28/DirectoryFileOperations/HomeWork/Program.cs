    ...
    class Program
    {
        static void Main(string[] args)
        {
            /*
             ...
             Yəni hər dəfə generate olunan zaman adamın aid olduğu ölkə folder'ində ona ad-soyad-random rəqəm.txt faylı yaradacaqsız :)             
             ...
             Bonus: Bunu edib bitirəndən sonra ölkələrin adları olan folderlərin içində 0-18, 19-35, 36-60, 60+ olaraq insanları 4 yaş qrupuna bölənə və statistikanı da buna görə göstərənə
             priz var :) Bonus hissəsini başlamamışdan proyekti kopyalayın başqa yerə ki, aləmi bir birinə qatanda əvvəlki halı əlinizdə olsun))) Qaş düzəldəndə göz çıxartmayaq :D
             */
        }
    }
}
