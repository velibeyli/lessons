    ...
    public class VirtualDatabase
    {
        public static List<Book> BooksTable = new List<Book>()
        {
            new Book()
            {
                ...
                ImagePath = @"C:\Users\Legion\Desktop\lessons\2022\February\21\WindowsFormsAppPart5\dunyanin-en-boyuk-sirri.jpg"
            },
            new Book()
            {
                Id=2,
                ...
                ImagePath = @"C:\Users\Legion\Desktop\lessons\2022\February\21\WindowsFormsAppPart5\das-evler.jpg"
            },
            new Book()
            {
                Id=3,
